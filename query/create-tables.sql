...
--------------------------------------------------------
  ...
  CREATE TABLE "C##SIAPDEV2"."DIMENSI_SATUAN" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##SIAPDEV2"."FAILED_JOBS" 
   ("ID" NUMBER, 
"CONNECTION" CLOB, 
"QUEUE" CLOB, 
"PAYLOAD" CLOB, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##SIAPDEV2"."MIGRATIONS" 
   ("ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "C##SIAPDEV2"."PASSWORD_RESETS" 
