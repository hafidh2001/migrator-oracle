...
BEGIN
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."ASSETACCOUNTS" MODIFY (
    "COA" VARCHAR2 (4 BYTE),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."ASSET_SAP_FAILED" MODIFY (
    "ID" NUMBER,
    "NO_ASET" VARCHAR2 (16 BYTE),
    "PERIODE" NUMBER,
    "TAHUN" NUMBER,
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."COSTCENTERS" MODIFY (
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."DEPRECIATIONS" MODIFY (
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."DEPRECIATION_VALUES" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
    "SUB_ASET" VARCHAR2 (4 BYTE),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."DETAILASSETS" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."DIMENSI_SATUAN" MODIFY ("NAME" VARCHAR2 (20 BYTE))';

  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."ELIMINATION" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
    "SUB_ASET" VARCHAR2 (4 BYTE),
    "NO_ITEM" NUMBER (2, 0),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."GROUPCLASSES" MODIFY (
    "ID" NUMBER,
    "NAMA_GROUP_KELAS" VARCHAR2 (50 BYTE),
    "KODE" NUMBER
  )';

  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."INSURANCES" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
    "SUB_ASET" VARCHAR2 (4 BYTE),
    "NO_ITEM" NUMBER (2, 0),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."MASTER_ASURANSI" MODIFY (
    "ID" NUMBER,
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."MONITORING_FAILED" MODIFY (
    "ID" NUMBER,
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."MONITORING_INTEGRATOR" MODIFY (
    "ID" NUMBER,
    "DESCRIPTION" VARCHAR2 (50 BYTE),
    "PERIODE" NUMBER (2, 0),
    "TAHUN" NUMBER (4, 0),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."NOTIFIKASI" MODIFY (
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."PBB" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
    "SUB_ASET" VARCHAR2 (4 BYTE),
    "NO_ITEM" NUMBER (2, 0),
    "NJOP" NUMBER (23, 2),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."PERIOD" MODIFY (
    "ID" NUMBER,
    "START_DATE" DATE,
    "END_DATE" DATE,
    "CREATED_BY" VARCHAR2 (20 BYTE),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."PERIOD_REQUEST" MODIFY (
    "ID" NUMBER,
    "START_DATE" DATE,
    "END_DATE" DATE,
    "STATUS" CHAR(1 BYTE),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."PICTUREASSETS" MODIFY (
    "NO_ASET" VARCHAR2 (16 BYTE),
    "SUB_ASET" VARCHAR2 (4 BYTE),
    "NO_ITEM" NUMBER (2, 0),
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE "C##SIAPDEV3"."REFERENCES" MODIFY (
    "ID" NUMBER,
    "KATEGORI" NUMBER (2, 0),
